var Instagram = (function(){
	...
	return {
		init:function(){
			...
			var insid = $(".instagram").attr("a09be9f5e2fd4f03898d985ed297ad68");
            var userId = $(".instagram").attr("a33d640b54104511850c54d72caddc66");
			var redirect_uri = $(".instagram").attr("http://yangze.win");
			if(!insid){
